import type { FolderReference } from '@/filtering/shared/domain/value-objects/FolderReference';
import type { FolderResolver } from '@/filtering/shared/domain/repository/FolderResolver';
